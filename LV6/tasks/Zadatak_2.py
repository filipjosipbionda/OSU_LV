...
def run_SVM(c, gamma):
    ...
    print(f'Accuracy train: {accuracy_score(y_train,y_train_p_SVM)}')
    print(f'Accuracy test: {accuracy_score(y_test,y_test_p_SVM)}')

    plot_decision_regions(X_train_n,y_train,classifier=SVM_model)
    plt.xlabel('x1')
    plt.ylabel('x2')
    plt.title(F'Accuracy: {accuracy_score(y_train,y_train_p_SVM)}')
    plt.tight_layout()
    plt.show()
